  ...
  return (
    <section className="py-20 px-4 bg-white">
      <div className="container mx-auto text-center">
        <h2 className="text-sm text-brand-black uppercase tracking-wide mb-4">
        ...
        <div className="flex justify-center mb-16">
          <Button className="bg-[#123F55] hover:bg-[#0F2C3A] text-white px-8 py-3 font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg group">
            Contact us
