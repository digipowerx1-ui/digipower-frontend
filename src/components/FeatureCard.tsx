...
const FeatureCard = ({ icon: Icon, title, description, delay = 0 }: FeatureCardProps) => {
  return (
    ...
    >
      <Card
        className="group h-full p-8 bg-gradient-to-br from-white to-gray-50/50 border border-gray-200/50 hover:border-brand-cyan/50 transition-all duration-500 hover:shadow-[0_20px_60px_rgba(1,211,255,0.15)] relative overflow-hidden"
      >
