...
const API_URL =
  ...
  "https://artistic-eggs-9d7a8f2a5f.strapiapp.com";
...
const Contact = () => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/api/contacts`, {
        ...
        headers: {
          ...
          Authorization: `Bearer ${API_TOKEN}`, // ✅ Strapi Cloud requires token
        },
        body: JSON.stringify({
          data: {
      ...
      if (res.ok) {
        ...
        setStatus(
          "❌ Failed to send: " + (error?.error?.message || "Unknown error")
        );
      }
    } catch (error) {
  ...
  return (
    <>
      <Helmet>
        <title>
          Contact DigiPowerX - Get in Touch for Energy Infrastructure Solutions
        </title>
        <meta
          name="description"
          content="Contact DigiPowerX for energy infrastructure, data center, and HPC solutions. Multiple locations across the US. Phone, email, and office information."
        />
        <meta
          name="keywords"
          content="contact DigiPowerX, energy infrastructure support, data center inquiries, HPC consultation"
        />
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 mb-8 animate-slide-up animation-delay-150">
                Ready to discuss your energy infrastructure needs? Our expert
                team is here to help you find the perfect solution for your
                requirements.
              </p>
            </div>
          </div>
                ...
                <Card className="shadow-card">
                  <CardHeader>
                    <CardTitle className="text-3xl text-brand-dark flex items-center">
                      <Send className="h-8 w-8 text-brand-white mr-3" />
                      Send us a Message
                    </CardTitle>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <Button
                      ...
                      className="w-full bg-[#123F55] hover:bg-brand-black-hover text-white"
                    >
                    ...
                    {contactInfo.map((info, index) => (
                      ...
                      >
                        <CardContent className="flex items-start space-x-4">
                          <div className="w-12 h-12 bg-[#123F55] rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
        ...
        <section className="py-20 px-4 bg-brand-light-gray">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-sm text-bg-[#123F55] uppercase tracking-wide mb-4">
                Our Locations
              </h2>
              ...
              <p className="text-lg text-brand-gray max-w-3xl mx-auto">
                Visit our facilities or contact local teams for region-specific
                inquiries
              </p>
            </div>
                ...
                >
                  <CardHeader>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <MapPin className="h-5 w-5 text-[#123F55]" />
                    </div>
              ...
              <CardContent className="p-0">
                <div className="h-96 bg-brand-light-gray flex items-center justify-center">
                  <div className="text-center">
                    <MapPin className="h-16 w-16 text-[#123F55] mx-auto mb-4" />
                    <h4 className="text-2xl font-bold text-brand-dark mb-2">
                      Interactive Map
                    </h4>
                    <p className="text-brand-gray">
                      Interactive facility map will be integrated here showing
                      all DigiPowerX locations
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <section className="py-20 px-4 bg-brand-dark text-white">
          <div className="container mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Ready to Start Your{" "}
              <span className="text-brand-white">Energy Project?</span>
            </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Our expert team is standing by to discuss your energy
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-[#123F55] hover:bg-[#2CD2FF] text-white px-8 py-3 transition-colors duration-300 rounded"
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white text-black hover:bg-white hover:text-brand-dark px-8 py-3"
              >
