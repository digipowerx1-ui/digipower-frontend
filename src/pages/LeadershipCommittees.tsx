...
export default function LeadershipCommittees() {
  const leaders: Leader[] = [
    ...
    },
    {
      ...
      img: "/Paul.jpeg",
      description:
  "Paul oversees DigiPowerX’s financial planning, capital structure, and investor relations.",
      expertise: ["Corporate Finance", "Capital Strategy", "Financial Management"],
      linkedIn: "#",
    },
    {
      name: "Daniel Rotunno",
    ...
    },
    {
      ...
      img: "/Ajay.jpeg",
      description:
        "Ajay Gupta joins the Board with extensive experience in engineering, infrastructure scaling, and technology investment.",
      expertise: ["Infrastructure", "Scaling", "Technology Investment"],
    },
  ];
