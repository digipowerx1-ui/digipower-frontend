    ...
    <>
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 animate-fade-in">
                Powering the
                <span className="text-brand-white"> Digital Future</span>
              </h1>
              ...
              <Button
                className="bg-brand-black hover:bg-[#94A3B8] text-white px-8 py-3 text-lg font-medium transition-all duration-300 hover:scale-105 animate-bounce-in animation-delay-300"
                size="lg"
              >
                Our Vision
              </Button>
          ...
          <div className="container mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="animate-slide-in-left">
                <h2 className="text-sm text-brand-black uppercase tracking-wide mb-4">Our Mission</h2>
                ...
                <p className="text-lg text-brand-gray mb-6 leading-relaxed">
                 With multiple sites, including our state-of-the-art combined cycle and high-capacity substations, we tap into and enhance the energy grid, supporting both industrial clients and broader energy markets.
                </p>
                ...
                <Button className="bg-black hover:bg-[#123F55] text-white">
                  Learn More
                </Button>
              </div>
              <div className="animate-slide-in-right">
                <Card className="p-8 shadow-card hover:shadow-energy transition-all duration-300">
                  <CardContent className="space-y-6">
                    <Building className="h-16 w-16 text-[#123F55] mx-auto" />
        ...
        <section className="py-20 px-4 bg-brand-light-gray">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-sm text-bold-[#123F55] uppercase tracking-wide mb-4">Our Values</h2>
              <h3 className="text-4xl md:text-5xl font-bold text-[#123F55] mb-6">
                What Drives Us Forward
              </h3>
              <p className="text-lg text-[#123F55] max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, index) => (
                ...
                >
                  <CardContent>
                    <value.icon className="h-12 w-12 text-[#123F55] mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" />
        ...
        <section className="py-20 px-4 bg-brand-dark text-white">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-sm text-brand-white uppercase tracking-wide mb-4">By The Numbers</h2>
        ...
        <section className="py-20 px-4 bg-white">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-sm text-[#123F55] uppercase tracking-wide mb-4">Leadership</h2>
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="p-8 shadow-card">
                <CardContent className="text-center">
                  <TrendingUp className="h-16 w-16 text-[#123F55] mx-auto mb-6" />
                  <h4 className="text-2xl font-bold text-[#123F55] mb-4">
                    Proven Track Record
                  </h4>
