  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { 
            boxShadow: "0 0 20px hsl(168 100% 60% / 0.3), 0 0 40px hsl(168 100% 60% / 0.1)" 
          },
          "50%": { 
            boxShadow: "0 0 40px hsl(168 100% 60% / 0.6), 0 0 80px hsl(168 100% 60% / 0.3)" 
          },
        },
        "glow-breathing": {
          "0%, 100%": { 
            filter: "drop-shadow(0 0 10px hsl(168 100% 60% / 0.5))" 
          },
          "50%": { 
            filter: "drop-shadow(0 0 25px hsl(168 100% 60% / 0.8))" 
          },
        },
        "gradient-wave": {
      ...
      animation: {
        ...
        "glow-breathing": "glow-breathing 4s ease-in-out infinite",
